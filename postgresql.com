...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-08-24T08:54:40.227114" />
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5oZ"> Migrate scheduled jobs to pg_timetable from pgAgent</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavlo Golub</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-08-23</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5oY"> PostGIS 3.3.0rc2</a></h3>
            <ul class="meta">
